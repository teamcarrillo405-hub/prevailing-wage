...
- [ ] **NFR-04** — Audit log `ssnEncrypted` field is always redacted before write; `hasFullSsn` boolean carries SSN-present signal in place of encrypted value.
