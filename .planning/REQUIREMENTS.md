...
- [ ] **WAL-03**: User can generate and download a WA L&I CPR XML file for upload to the My L&I PWIA portal; export is gated on the contractor providing their PWIA `intentId` (issued after Statement of Intent approval); WA trade codes validated before generation
